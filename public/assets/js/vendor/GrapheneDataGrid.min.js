...
{{^options.query}}
{{#options.search}}<input type="text" autocomplete="off" name="search" class="form-control pull-right" style="max-width:300px; margin-bottom:10px" aria-label="query search" placeholder="Search">{{/options.search}}
{{/options.query}}
