...
{{^options.query}}
{{#options.search}}
<label for="grapheneOptsSearch" class="sr-only">Search</span>
<input type="text" autocomplete="off" name="search" class="form-control pull-right" style="max-width:300px; margin-bottom:10px" aria-label="query search" placeholder="Search" id="grapheneOptsSearch">{{/options.search}}
{{/options.query}}
<span style="margin-right:auto" name="count"></span>

{{#options.query.bar}}
<label for="grapheneOptionsSearch" class="sr-only">Search</span>
<input type="text" autocomplete="off" name="query" class="form-control pull-left" style=" aria-label="query bar" margin-bottom:10px;max-width:{{options.query.width}}%;" placeholder="" id="grapheneOptionsSearch">
{{/options.query.bar}}
</div>
