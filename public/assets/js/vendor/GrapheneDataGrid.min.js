...
gform.stencils.data_grid += `<label for="grapheneOptionsSearchBar` + rand() + `" class="sr-only">Search</span>
<input type="text" autocomplete="off" name="query" class="form-control pull-left" style=" aria-label="query bar" 
margin-bottom:10px;max-width:{{options.query.width}}%;" placeholder="" id="grapheneOptionsSearchBar` + rand() + `">
{{/options.query.bar}}
</div>
