workflow_report.report = `<div>
  ...
  <div class="panel">
    <div class="panel-body">
      ...
      <div class="dropzone" id="uploader_{{original.workflow_submission_id}}"><center>Drop files here to upload attachments<i class="fa fa-spinner fa-spin" style="font-size:60px;margin:40px auto;color:#eee"></i></center></div>
      {{/current_state.uploads}}
      {{/workflow.instance.version.code.form.files}}`;