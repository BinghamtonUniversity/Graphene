...
return [
    ...
    */
    'cas_hostname'        => env('CAS_HOSTNAME', 'example.com'),
    ...
    */
    'cas_real_hosts'      => env('CAS_REAL_HOSTS', 'example.com'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'cas_debug'           => env('CAS_DEBUG',isset($_SERVER['CAS_DEBUG'])?$_SERVER['CAS_DEBUG']:false),
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | This is how the CAS SAML user meta data maps to the Graphene User Structure.
     */
    'cas_saml_map'        => env('CAS_MASQUERADE', [
        "email" => "email", 
        "last_name" => "last_name", 
        "unique_id" => "unique_id", 
