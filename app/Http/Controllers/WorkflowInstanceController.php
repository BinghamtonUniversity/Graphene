    ...
    public function getcsv(Request $request, WorkflowInstance $workflow_instance) {
        ...
        foreach($submissions as $submission) {
            ...
            $data = array_merge($flat, [
                ...
                'opened_at' => ($submission->opened_at == null)?'':(is_string($submission->opened_at)?$submission->opened_at:$submission->opened_at->format('Y-m-d H:i:s')),
    ...
    public function getraw(Request $request, WorkflowInstance $workflow_instance) {
        ...
        foreach($submissions as $submission) {
            ...
            $workflow_metadata = [
                ...
                '_w_opened_at' => ($submission->opened_at == null)?'':(is_string($submission->opened_at)?$submission->opened_at:$submission->opened_at->format('Y-m-d H:i:s')),
